...
<ParamField body="query" type="Query" required>
  <Expandable title="Query"> 
    <ParamField body="lingua" type="string">
    ...
    <ParamField body="search_method" type="'exact'|'relevant'">
      The method to use when searching for results. 
      
      <Info>If defined, `lingua` will be ignored and the Context Agent will rely on the other parameters to find your context.</Info>
    </ParamField>
  </Expandable> 
</ParamField>
<ParamField body="library" type="string" default="sample">
