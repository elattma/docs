...
---
The test dataset contains data from four integrations: `google_mail`, `google_docs`, `zoho`, and `zendesk`. It simulates data from an enterprise and focuses on the enterprise's customers.
## Customers (Zoho)
| Account | Contact(s) |
| --- | --- |
| King | Kris Marrier |
