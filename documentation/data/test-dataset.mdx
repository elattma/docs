---
title: Test Dataset
description: An outline of the data that exists in the default test dataset
---
The test dataset includes information from four integrations: Gmail, Google Docs, Zoho CRM, and Zendesk Customer Support. This dataset mimics data from an enterprise and specifically centers on the enterprise's customers.
## Customers (Zoho CRM)
| Account | Contact(s) |
| --- | --- |
| King | Kris Marrier |
