...
---
Mimo is a unified data platform for AI that goes beyond traditional vector database implementations. 

Make your data AI-ready With Mimo by seamlessly connecting your SaaS products (like Google Docs, Salesforce CRM) or data lake. 
...
4. With the library ID and your agent's API key, your agent can now query the end user's data library by calling the Mimo API.
